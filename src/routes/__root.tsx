...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "MédinaStay — Immobilier méditerranéen" },
      {
        name: "description",
        content:
          "Trouvez votre villa, appartement ou maison d'hôtes en Tunisie et à l'international. Vente, location et vacances.",
      },
      { property: "og:title", content: "MédinaStay" },
      { property: "og:description", content: "Plateforme immobilière méditerranéenne." },
